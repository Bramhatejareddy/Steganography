...
# Load cover image
img = cv2.imread("mypic.jpeg")  # Ensure this image exists in your working direory
if img is None:
    print("Cover image is not found!")
    exit()
...
cv2.imwrite("mypicencrypted.jpeg", img)
os.system("start encryptedImage.jpeg")  # For Windows; on macOS use 'open' and on Linux 'xdg-open'
